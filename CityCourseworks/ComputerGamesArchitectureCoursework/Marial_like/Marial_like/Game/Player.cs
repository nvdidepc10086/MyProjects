...
namespace MarialLike2D
{
    ...
    class Player
    {
        ...
        public void OnKilledByTrap(Trap_Buttom killedBy)
        {
            isAlive = false;
        ...
        */
        // Add this method inside the Player class
        public void Draw(GameTime gameTime, SpriteBatch spriteBatch, float sceneOffsetY)
        {
            ...
            // Draw that sprite.
            sprite.Draw(gameTime, spriteBatch, Position + new Vector2(0, sceneOffsetY), flip);
        }
